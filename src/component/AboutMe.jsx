    ...
    <div className="main">
      <section id="about-me" className="about-me-section">
        ...
        <p id="background">
          ...
          worked as a HR assistant for Hyundai for around 2 years. I am
          determined to make my dream come true so in February 2019 I quit my
        ...
        <p id="interest">
          ...
          there my interest grew and grew. Coding was not something I ever
          imagined my self doing and a subject I had very little knowledge on
          until recently. However, after spending time speaking with people from
          the industry, attending meet ups, watching hours of youtube videos,
          studying via online classes and practicing at home, I have found
          something that I am incredibly passionate about. I have recently
